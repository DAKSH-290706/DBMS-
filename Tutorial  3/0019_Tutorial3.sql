...
(1, 'Aarav', 'Sharma', '2005-01-15', '10A', 85, 'Delhi'),
(2, 'Ananya', 'Singh', '2004-12-30', '11B', 92, 'Mumbai'),
(3, 'Rohan', 'Patel', '2005-01-10', '10A', 78, 'Ahmedabad'),
(4, 'Sneha', 'Kumar', '2003-06-25', '12C', 88, 'Bangalore'),
(5, 'Karan', 'Gupta', '2005-07-14', '10B', 74, 'Chennai');

insert into Teacher (TeacherID, FirstName, LastName, Subject, HireDate, Salary) values
(1, 'Rajesh', 'Verma', 'Maths', '2010-08-01', 52000.00),
(2, 'Neha', 'Joshi', 'Science', '2015-03-15', 48000.00),
(3, 'Vikram', 'Reddy', 'English', '2008-11-20', 55000.00);
