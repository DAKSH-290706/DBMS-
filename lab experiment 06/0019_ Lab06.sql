...
-- 'root@localhost', 'DAKSH D', '8.4.6', '2025-09-29 11:28:45'
...
SELECT department_id, COUNT(*) AS NoInDepartments
FROM employees
GROUP BY department_id;

-- Paste the output of above code and comment your output

/* # Department_ID, NoInDepartments
NULL, '1'
'10', '1'
'20', '2'
'30', '6'
...
SELECT department_id, COUNT(*) AS CountEmployees
FROM employees
GROUP BY department_id
HAVING COUNT(*) > 10;
...
/* # department_id, MaxSalary, MinSalary, AvgSalary
...
SELECT YEAR(hire_date) AS HireYear, COUNT(*) AS CountHired
FROM employees
...
SELECT e.job_id, j.job_title, AVG(e.salary) AS AvgSalary
FROM employees e
...
SELECT department_id, AVG(commission_pct) AS AvgCommission
FROM employees
...
SELECT manager_id, COUNT(*) AS CountEmployees
FROM employees
...
ORDER BY department_id, TotalSalary DESC;

-- Paste the output of above code and comment your output

/* # department_id, job_id, TotalSalary
NULL, 'SA_REP', '7000.00'
'10', 'AD_ASST', '4400.00'
'20', 'MK_MAN', '13000.00'
'20', 'MK_REP', '6000.00'
